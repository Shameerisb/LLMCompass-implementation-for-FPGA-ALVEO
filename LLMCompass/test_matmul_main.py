# testing for the optimized version of the matmul workload according to the hardware defined as in the original paper code(i.e. TPUv3, TPUv3_new, A100_80GB_fp16)
# If you want to reproduce the results on your specific hardware(i.e. ALVEO U100 ect), please make sure to write hardware description in specific python files in the hardware directory.
